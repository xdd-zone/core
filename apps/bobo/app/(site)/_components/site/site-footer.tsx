...
export function SiteFooter() {
  return (
    <footer className="relative mt-20 overflow-hidden pb-8 pt-20 transition-colors duration-300">
      ...
      <div className="pointer-events-none absolute inset-0 bg-[color-mix(in_oklab,var(--theme-lavender)_18%,var(--theme-base))] mask-[linear-gradient(to_bottom,transparent,black)] dark:bg-[color-mix(in_oklab,var(--theme-lavender)_3%,var(--theme-crust,#11111b))]" />
