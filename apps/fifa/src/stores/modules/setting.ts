import type { ThemeName } from '@fifa/utils/theme'
import type { BaseStore } from '../types'
import { catppuccinThemes, getThemeById } from '@fifa/config/catppuccin'
    ...
    (set, get) => {
      ...
      return {
        ...
        setLanguage: async (language: string) => {
          ...
          const { getI18nInstance } = await import('@fifa/i18n/instance')
