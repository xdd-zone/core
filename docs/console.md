...
- 评论接口：`GET /api/comment`、`GET /api/comment/:id`、`PATCH /api/comment/:id/status`、`DELETE /api/comment/:id`
...
- 内容管理页面入口在 `packages/console/src/pages/article/*`
- 内容管理路由定义在 [packages/console/src/app/router/routes.tsx](../packages/console/src/app/router/routes.tsx)
- 内容管理导航入口在 [packages/console/src/app/navigation/navigation.ts](../packages/console/src/app/navigation/navigation.ts)
