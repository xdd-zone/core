export const BizCode = {
  ...
  CONTENT_PREVIEW_TOKEN_EXPIRED: 'CONTENT.PREVIEW_TOKEN_EXPIRED',
  CONTENT_SLUG_CONFLICT: 'CONTENT.SLUG_CONFLICT',
  CONTENT_TAXONOMY_SLUG_CONFLICT: 'CONTENT.TAXONOMY_SLUG_CONFLICT',
  CONTENT_UNKNOWN_MDX_COMPONENT: 'CONTENT.UNKNOWN_MDX_COMPONENT',
  SYSTEM_INTERNAL_ERROR: 'SYSTEM.INTERNAL_ERROR',
  SYSTEM_LOGS_DISABLED: 'SYSTEM.LOGS_DISABLED',
  SYSTEM_LOGS_UNAVAILABLE: 'SYSTEM.LOGS_UNAVAILABLE',
