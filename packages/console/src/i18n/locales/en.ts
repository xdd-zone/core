  ...
  content: {
    ...
    post: {
      ...
      detail: {
        ...
        copyPublicApi: 'Copy Public API',
        openPublicApi: 'Open Public API',
        publicApi: 'Public API',
        publicCopyFailed: 'Failed to copy public API URL',
        publicCopySuccess: 'Public API URL copied',
        publicDraftHint: 'Draft posts do not have a public read API',
        publicReadable: 'Readable',
        publicState: 'Public API',
