export default {
  ...
  content: {
    ...
    post: {
      ...
      detail: {
        ...
        copyPublicApi: 'Copy Personal Site API',
        openPublicApi: 'Open Personal Site API',
        publicApi: 'Personal Site API',
        publicCopyFailed: 'Failed to copy personal site API URL',
        publicCopySuccess: 'Personal site API URL copied',
        publicDraftHint: 'Draft posts do not have a personal site read API',
        publicReadable: 'Readable',
        publicState: 'Personal Site API',
        publicUnreadable: 'Not readable',
    ...
    category: {
      ...
      confirmDeleteDescription: 'Posts using this category will become uncategorized.',
      confirmDeleteTitle: 'Delete this category?',
      description: 'Manage post categories, public visibility, and ordering here.',
      ...
      resultsTitle: 'Category List',
      summary: {
        hidden: 'Hidden on page',
        posts: 'Posts on page',
        total: 'Categories',
      ...
      validation: {
        ...
        slugRequired: 'Please enter a category slug',
      },
      visible: {
        all: 'All states',
        hidden: 'Hidden',
    ...
    comment: {
      ...
      create: {
        ...
        placeholders: {
          ...
          content: 'Enter comment content',
          email: 'name@example.com',
          post: 'Select a published post',
        },
        ...
        validation: {
          ...
          emailInvalid: 'Invalid email format',
          postRequired: 'Please select a post',
        },
      },
      filters: {
    ...
    media: {
      ...
      unsupportedType: 'Only PNG, JPG, WebP, GIF, or AVIF images are allowed',
      upload: 'Upload Media',
      uploaded: 'Media uploaded',
      uploadHint:
        'Only PNG, JPG, WebP, GIF, or AVIF images are allowed. Copy the URL after upload and use it in posts.',
      uploadSkipped: 'Some files were skipped. Check file size or try again.',
      uploadTitle: 'Upload Entry',
    },
    settings: {
      description: 'Maintain the site configuration here.',
      form: {
  ...
  menu: {
    ...
    mediaManagement: 'Media Resources',
